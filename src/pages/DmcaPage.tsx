...
const DmcaPage: React.FC = () => {
    return (
        <div className="container mx-auto px-6 py-20 max-w-3xl text-gray-200">
            <h1 className="text-4xl md:text-5xl font-bold mb-10 text-white leading-tight">DMCA Compliance</h1>

            <div className="space-y-8 text-lg leading-relaxed text-gray-300">
                <p>
                    MagnetFinder respects the intellectual property rights of others and expects its users to do the same. In accordance with the Digital Millennium Copyright Act of 1998, the text of which may be found on the U.S. Copyright Office website at <a href="http://www.copyright.gov/legislation/dmca.pdf" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors underline decoration-blue-400/30 hover:decoration-blue-400">copyright.gov/legislation/dmca.pdf</a>, we will respond expeditiously to claims of copyright infringement committed using the MagnetFinder service that are reported to our Designated Copyright Agent.
                </p>

                <div>
                    <h2 className="text-2xl font-bold mt-10 mb-4 text-white">Takedown Notice</h2>
                    <p>
                ...
                <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700/50 mt-10 backdrop-blur-sm">
                    ...
                    <a href="mailto:dmca@magnetfinder.com" className="text-2xl font-bold text-blue-400 hover:text-blue-300 transition-colors">
