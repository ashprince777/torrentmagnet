    ...
    return (
        <div className="container mx-auto px-6 py-20 max-w-3xl text-text-secondary">
            ...
            <div className="space-y-8 text-lg leading-relaxed">
                ...
                <div className="bg-surface/50 p-8 rounded-xl border border-white/5 mt-10 backdrop-blur-sm">
                    ...
                    <a href="mailto:dmca@magnetfinder.com" className="text-2xl font-bold text-primary hover:text-accent transition-colors">
