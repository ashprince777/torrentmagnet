    ...
    return (
        <div className="container mx-auto px-6 py-20 max-w-3xl text-text-secondary">
            ...
            <div className="space-y-8 text-lg leading-relaxed">
                ...
                <div className="bg-surface/50 p-8 rounded-xl border border-white/5 mt-12 backdrop-blur-sm">
                    <h2 className="text-2xl font-semibold mb-4 text-white">Important Disclaimer</h2>
                    <p className="mb-4">
                        MagnetFinder <strong className="text-primary">does not host, store, or distribute any files</strong>. We only index text-based metadata (magnet links and hashes) that are already publicly available on the internet.
                    </p>
                    <p>
