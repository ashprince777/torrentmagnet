...
const AboutPage: React.FC = () => {
    return (
        <div className="container mx-auto px-6 py-20 max-w-3xl text-gray-200">
            <h1 className="text-4xl md:text-5xl font-bold mb-10 text-white leading-tight">About MagnetFinder</h1>
            ...
            <div className="space-y-8 text-lg leading-relaxed text-gray-300">
                ...
                <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700/50 mt-12 backdrop-blur-sm">
                    <h2 className="text-2xl font-semibold mb-4 text-white">Important Disclaimer</h2>
                    <p className="mb-4">
                        MagnetFinder <strong className="text-blue-400">does not host, store, or distribute any files</strong>. We only index text-based metadata (magnet links and hashes) that are already publicly available on the internet.
                    </p>
                    <p>
